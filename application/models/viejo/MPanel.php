...
class MPanel extends CI_Model {
    ...
    function año() {
        ...
        $SQL = "SELECT año FROM `concurso` WHERE estado='creado' OR estado='iniciado'";
        $query = $this->db->query($SQL);
        $query = $query->row();
        if ($query == false) {
            return "cerrado";
   ...
   function concursodetalle($id) {
    ...
    function consultarR02(&$pagina, &$total_paginas, $curso = "", $tipo = "", $buscar = "") {
        ...
        $SQL = "SELECT estudiante.nombre AS 'nombre',estudiante.dni AS 'dni', estudiante.apellido_p AS 'apellido_p', estudiante.apellido_m AS 'apellido_m',apoderado.nombre AS 'nombre_p', "
                . "apoderado.apellido_p AS 'papellido_p',apoderado.dni AS 'dni', apoderado.apellido_m AS 'papellido_m', obra.nombre AS 'obra',"
                . " obra.reto ,codigo.code,registros.forma_entrega, colegio.nombre AS 'colegio', registros.id_codigo, registros.id_concurso, "
    ...
    function consultarObra(&$pagina, &$total_paginas, $curso = "", $buscar = "") {
    ...
    function consultarCodigos(&$pagina, &$total_paginas, $searchValue = "") {
    ...
    function estado($id,$std) {
     ...
     function editar_concurso($año, $inicio, $cierre, $premiacion,$id) {
        ...
        $query = $this->db->query("UPDATE `concurso` SET  
              año='$año', fecha_inicio='$inicio', fecha_final='$cierre', fecha_premiacion='$premiacion',fecha_registro='$fecha_registro' 
              WHERE id='$id'");
