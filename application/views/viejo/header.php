                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li style="margin-top: 2%;">
                            Estado del sistema: <br><b> Concurso:  <span style="color:#fff;"><?Php if (($estadoc!=="cerrado") AND ($estadoc !=="")){ echo $estadoc->estado;}else{ echo "Sin concursos";} ?></span></b>
                        </li>    
