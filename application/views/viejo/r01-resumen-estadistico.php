...
<div class="row">
    <div class="col-md-3">
        <a class="btn btn-primary btn-block" href="<?= base_url(); ?>Reportes/ER01/<?php echo $curso; ?>" style="width: 100px">Exportar</a>
    </div> 
</div>
<br>
<div class="row">
                    ...
                    <div class="col-md-6 table-responsive">
                        ...
                        <table class="table table-bordered table-width80" id="dataTable" width="100%" cellspacing="0" style="margin-top:2%;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Video</td>
                                    <td><?php echo round($reto["c3"], 2); ?>%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
